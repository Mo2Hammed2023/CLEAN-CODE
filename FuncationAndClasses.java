...
public class FuncationAndClasses {
    ...
    public static void print(Student[] stu) {
        for (int Student_counter = 0; Student_counter < stu.length; Student_counter++) {
            ...
            for (int  Student_degrees= 0; Student_degrees < stu[Student_degrees].deg.length; Student_degrees++) {
                System.out.print(stu[Student_counter].deg[Student_degrees] + "\t");
            }
    ...
    public static void main(String[] args) {
        ...
        } while (num_of_opration != stop_point);
    }
}
